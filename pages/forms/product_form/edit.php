                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" name="proCode" value="<?php echo $rowPro['product_code'] ?>"
                                    required>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" name="proName" value="<?php echo $rowPro['product_name'] ?>"
                                    required>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="brand" id="">
                                    ...
                                    <?php while ($rowBrand = mysqli_fetch_array($queryBrand)) { ?>
                                        <option value="<?php echo $rowBrand['id'] ?>" <?php echo ($rowPro['brand_id'] === $rowBrand['id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="unit" id="" required>
                            ...
                            <option value="ตลับ" <?php echo ($rowPro['unit'] === 'ตลับ') ? 'selected' : ''; ?>>ตลับ
                            </option>
                            <option value="ซอง" <?php echo ($rowPro['unit'] === 'ซอง') ? 'selected' : ''; ?>>ซอง</option>
                            <option value="แท่ง" <?php echo ($rowPro['unit'] === 'แท่ง') ? 'selected' : ''; ?>>แท่ง
                            </option>
                            <option value="กระปุก" <?php echo ($rowPro['unit'] === 'กระปุก') ? 'selected' : ''; ?>>กระปุก
                            </option>
                            <option value="กล่อง" <?php echo ($rowPro['unit'] === 'กล่อง') ? 'selected' : ''; ?>>กล่อง
                            </option>
                        </select>
                    </div>
                    <!-- description -->
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="" rows="2"
                            value="<?php echo $rowPro['description'] ?>"></textarea>
                    </div>
                    <!-- btn -->
